	...
	*/
	...
	Outcome<llvm::Value*, Error> Variable::Codegen(const Environment& env)
	{
      ...
      else
      {
        ...
        //    return B
        //
        // 3) When we want to use the pointer itself as a value within an expression 
        ...
        //    return B
        //
        // 4) When we want to use the value pointed to by the pointer within an expression 
