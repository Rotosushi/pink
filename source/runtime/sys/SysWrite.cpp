...
auto SysWriteText(llvm::Value      *file_descriptor,
  ...
  auto *text_size_ptr =
      env.instruction_builder->CreateConstInBoundsGEP2_32(text_type,
                                                          text_ptr,
                                                          0,
                                                          0);
  auto *text_buffer_ptr =
      env.instruction_builder->CreateConstInBoundsGEP2_32(text_type,
                                                          text_ptr,
                                                          0,
                                                          1);
...
auto SysWrite(llvm::Value *file_descriptor,
  ...
  if (llvm::isa<llvm::ConstantInt>(file_descriptor)) {
    ...
    mov_rdi = llvm::InlineAsm::get(mov_rdi_type,
                                   "mov rdi, $1",
                                   "={rdi},i",
                                   /* hasSideEffects = */ true,
                                   /* isAlignStack = */ false,
  ...
  auto *mov_rsi = llvm::InlineAsm::get(mov_rsi_type,
                                       "mov rsi, $1",
                                       "={rsi},r",
                                       /* hasSideEffects = */ true,
                                       /* isAlignStack = */ false,
  ...
  auto *mov_rdx = llvm::InlineAsm::get(mov_rdx_type,
                                       "mov rdx, $1",
                                       "={rdx},r",
                                       /* hasSideEffects = */ true,
                                       /* isAlignStack = */ false,
  ...
  auto *mov_rax = llvm::InlineAsm::get(mov_rax_type,
                                       "mov rax, $1",
                                       "={rax},i",
                                       /* hasSideEffects = */ true,
                                       /* isAlignStack = */ false,
  ...
  auto *syscall = llvm::InlineAsm::get(syscall_asm_type,
                                       "syscall",
                                       "={rax}",
                                       /* hasSideEffects = */ true,
                                       /* isAlignStack = */ false,
