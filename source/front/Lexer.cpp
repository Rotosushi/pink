/* Generated by re2c 3.0 on Fri Oct 21 15:42:42 2022 */
...
yy11:
#line 208 "source/front/Lexer.re"
...
#line 356 "source/front/Lexer.cpp"
yy15:
	yych = *++cursor;
	switch (yych) {
		case '!':
...
#line 380 "source/front/Lexer.cpp"
yy17:
	yyaccept = 0;
	yych = *(marker = ++cursor);
yy18:
...
#line 455 "source/front/Lexer.cpp"
yy20:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 484 "source/front/Lexer.cpp"
yy24:
	++cursor;
#line 203 "source/front/Lexer.re"
	{ UpdateLoc(); return Token::RBracket; }
#line 489 "source/front/Lexer.cpp"
yy25:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 578 "source/front/Lexer.cpp"
yy37:
	yych = *++cursor;
	switch (yych) {
		case ':': goto yy56;
...
#line 702 "source/front/Lexer.cpp"
yy44:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 792 "source/front/Lexer.cpp"
yy48:
	yyaccept = 3;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 866 "source/front/Lexer.cpp"
yy50:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1054 "source/front/Lexer.cpp"
yy60:
	yyaccept = 5;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1128 "source/front/Lexer.cpp"
yy62:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1218 "source/front/Lexer.cpp"
yy66:
	yyaccept = 7;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1292 "source/front/Lexer.cpp"
yy68:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1382 "source/front/Lexer.cpp"
yy72:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1464 "source/front/Lexer.cpp"
yy75:
	yyaccept = 10;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1612 "source/front/Lexer.cpp"
yy79:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1694 "source/front/Lexer.cpp"
yy82:
	yyaccept = 13;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1768 "source/front/Lexer.cpp"
yy84:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1850 "source/front/Lexer.cpp"
yy87:
	yyaccept = 15;
	yych = *(marker = ++cursor);
	switch (yych) {
