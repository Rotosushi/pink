/* Generated by re2c 3.0 on Thu Oct 13 09:26:38 2022 */
...
#line 164 "source/front/Lexer.cpp"
{
	char yych;
...
yy1:
	++cursor;
#line 215 "source/front/Lexer.re"
...
yy3:
#line 214 "source/front/Lexer.re"
	{ UpdateLoc(); continue; }
#line 281 "source/front/Lexer.cpp"
yy4:
	yych = *++cursor;
	switch (yych) {
		case '!':
...
#line 344 "source/front/Lexer.cpp"
yy12:
	yych = *++cursor;
	switch (yych) {
		case '=': goto yy36;
...
#line 354 "source/front/Lexer.cpp"
yy14:
	++cursor;
#line 197 "source/front/Lexer.re"
	{ UpdateLoc(); return Token::Semicolon;
       }
#line 360 "source/front/Lexer.cpp"
yy15:
	yych = *++cursor;
	switch (yych) {
		case '!':
...
#line 384 "source/front/Lexer.cpp"
yy17:
	yyaccept = 0;
	yych = *(marker = ++cursor);
yy18:
...
#line 459 "source/front/Lexer.cpp"
yy20:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 493 "source/front/Lexer.cpp"
yy25:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 582 "source/front/Lexer.cpp"
yy37:
	yych = *++cursor;
	switch (yych) {
		case ':': goto yy56;
...
#line 706 "source/front/Lexer.cpp"
yy44:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 796 "source/front/Lexer.cpp"
yy48:
	yyaccept = 3;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 870 "source/front/Lexer.cpp"
yy50:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1058 "source/front/Lexer.cpp"
yy60:
	yyaccept = 5;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1132 "source/front/Lexer.cpp"
yy62:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1222 "source/front/Lexer.cpp"
yy66:
	yyaccept = 7;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1296 "source/front/Lexer.cpp"
yy68:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1386 "source/front/Lexer.cpp"
yy72:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1468 "source/front/Lexer.cpp"
yy75:
	yyaccept = 10;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1542 "source/front/Lexer.cpp"
yy77:
	yyaccept = 11;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1616 "source/front/Lexer.cpp"
yy79:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1698 "source/front/Lexer.cpp"
yy82:
	yyaccept = 13;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1772 "source/front/Lexer.cpp"
yy84:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1854 "source/front/Lexer.cpp"
yy87:
	yyaccept = 15;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1928 "source/front/Lexer.cpp"
yy89:
#line 216 "source/front/Lexer.re"
	{ UpdateLoc(); return Token::End; }
#line 1932 "source/front/Lexer.cpp"
}
#line 217 "source/front/Lexer.re"
