/* Generated by re2c 3.0 on Mon Jan  9 15:20:11 2023 */
...
#line 183 "source/front/Lexer.re"
	{ UpdateLoc(); continue; }
#line 251 "source/front/Lexer.cpp"
yy4:
	yych = *++cursor;
	switch (yych) {
		case '!':
...
#line 314 "source/front/Lexer.cpp"
yy12:
	yych = *++cursor;
	switch (yych) {
		case '=': goto yy36;
...
#line 324 "source/front/Lexer.cpp"
yy14:
	++cursor;
#line 167 "source/front/Lexer.re"
	{ UpdateLoc(); return Token::Semicolon;}
#line 329 "source/front/Lexer.cpp"
yy15:
	yych = *++cursor;
	switch (yych) {
		case '!':
...
#line 428 "source/front/Lexer.cpp"
yy20:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 465 "source/front/Lexer.cpp"
yy25:
	++cursor;
...
#line 683 "source/front/Lexer.cpp"
yy45:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 773 "source/front/Lexer.cpp"
yy49:
	yyaccept = 3;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 847 "source/front/Lexer.cpp"
yy51:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1035 "source/front/Lexer.cpp"
yy61:
	yyaccept = 5;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1109 "source/front/Lexer.cpp"
yy63:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1199 "source/front/Lexer.cpp"
yy67:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1289 "source/front/Lexer.cpp"
yy71:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1371 "source/front/Lexer.cpp"
yy74:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1461 "source/front/Lexer.cpp"
yy78:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1543 "source/front/Lexer.cpp"
yy81:
	yyaccept = 11;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1617 "source/front/Lexer.cpp"
yy83:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1715 "source/front/Lexer.cpp"
yy88:
	yyaccept = 13;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1789 "source/front/Lexer.cpp"
yy90:
	yyaccept = 0;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1879 "source/front/Lexer.cpp"
yy94:
	yyaccept = 15;
	yych = *(marker = ++cursor);
	switch (yych) {
...
#line 1953 "source/front/Lexer.cpp"
yy96:
#line 185 "source/front/Lexer.re"
	{ UpdateLoc(); return Token::End; }
#line 1957 "source/front/Lexer.cpp"
}
