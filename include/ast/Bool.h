...
namespace pink {
    ...
    private:
         ...
         * 
         * @param env The [Environment](#Environment) which is used to get a [BoolType](#BoolType) from the [TypeInterner](#TypeInterner)
         * @return Outcome<Type*, Error> A [BoolType](#BoolType) from the [TypeInterner](#TypeInterner) held in [env](#Environment)
         */
    ...
    public:
        ...
        /**
         * @brief This function converts the boolean value held into it's textual representation.
         * 
        ...
        /**
         * @brief This function converts the boolean value held into it's llvm representation.
         * 
         ...
         * 
         * [llvmValue]: https://llvm.org/doxygen/classllvm_1_1Value.html "llvm::Value*"
         ...
         * 
         * @param env The Environment which holds the [instruction_builder] used to construct the [ConstantInt]
