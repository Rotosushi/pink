...
namespace pink {
    ...
    public:
        ...
        /**
         * @brief We never want to construct a new symbol table as a copy of another symbol table
         * 
         ...
         * 
         * if the symbol was not within this table and this is not the global symbol table
         * then this function calls Lookup on the outer symbol table, to attempt to resolve
         * the symbol at the higher scope.
         * 
         * @param symbol the symbol to resolve
         * @return llvm::Optional<std::pair<Type*, llvm::Value*>> if this option contains anything, it is the resolved type and value of the symbol.
         * otherwise the symbol could not be resolved within this scope or any scope this scope is within. 
         */
         ...
         * @brief Attempts to resolve the given symbol to it's bound type and value.
         * 
         * if the symbol was not within this table, then we simply return the empty option.
         * there is no recursive lookup performed by this function.
         * 
         ...
         * of duplicate symbols. nor does it check that type or value are not nullptrs.
         *  
