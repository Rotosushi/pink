...
bool TestApplication(std::ostream &out) {
  ...
  pink::Outcome<std::unique_ptr<pink::Ast>, pink::Error> fn =
  ...
  std::unique_ptr<pink::Ast> fnname =
  ...
  std::unique_ptr<pink::Application> app(
      new pink::Application(apploc, std::move(fnname), std::move(args)));
  ...
  result &= Test(out, "Application::Getype()",
