...
bool TestStringInterner(std::ostream& out)
{
    ...
    */
    ...
    {
        out << "\tTest pink::StringInterner::Intern(std::string&), unique string is valid: Passed\n";
    }
    else
    {
        result = false;
        out << "\tTest pink::StringInterner::Intern(std::string&), unique string is valid: Failed\n";
    }
    ...
    */
    ...
    {
        out << "\tTest pink::StringInterner::Intern(std::string&), two unique strings compare not-equal: Passed\n";
    }
    else
    {
        result = false;
        out << "\tTest pink::StringInterner::Intern(std::string&), two unique strings compare not-equal: Failed\n";
    }
    ...
    */
    ...
    {
        out << "\tTest pink::StringInterner::Intern(std::string&), duplicate string compares equal: Passed\n";
    }
    else
    {
        result = false;
        out << "\tTest pink::StringInterner::Intern(std::string&), duplicate string compares equal: Failed\n";
    }
