...
TEST_CASE("aux/TypeInterner", "[unit][aux]") {
  ...
  pink::Type::Pointer  type_variable_T = interner.GetTypeVariable(variable_T);
  pink::Type::Pointer  type_variable_U = interner.GetTypeVariable(variable_U);
  pink::Type::Pointer  duplicate_U     = interner.GetTypeVariable(variable_U);
