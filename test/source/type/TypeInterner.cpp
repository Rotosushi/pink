...
TEST_CASE("aux/TypeInterner", "[unit][aux]") {
  ...
  pink::TypeInterface::Pointer five_integer_array_type =
  ...
  pink::TypeInterface::Pointer five_boolean_array_type =
  ...
  pink::TypeInterface::Pointer boolean_pair_type =
  ...
  pink::TypeInterface::Pointer int_bool_pair =
  ...
  pink::TypeInterface::Pointer integer_binop_function =
  ...
  pink::TypeInterface::Pointer boolean_binop_function =
  ...
  pink::TypeInterface::Pointer integer_unop_function =
  ...
  pink::TypeInterface::Pointer boolean_unop_function =
  ...
  pink::TypeInterface::Pointer type_variable_T =
      interner.GetTypeVariable(variable_T);
  pink::TypeInterface::Pointer type_variable_U =
      interner.GetTypeVariable(variable_U);
  pink::TypeInterface::Pointer duplicate_U =
      interner.GetTypeVariable(variable_U);
