...
bool TestToken(std::ostream& out)
{
    ...
    result &= Test(out, "Token::FullyQualifiedId", Testlet("Token::FullyQualifiedId", pink::Token::FullyQualifiedId));
    result &= Test(out, "Token::Op",        Testlet("Token::Op",         pink::Token::Op));
    result &= Test(out, "Token::Dot",       Testlet("Token::Dot",        pink::Token::Dot));
    result &= Test(out, "Token::Comma",     Testlet("Token::Comma",      pink::Token::Comma));
    result &= Test(out, "Token::Colon",     Testlet("Token::Colon",      pink::Token::Colon));
    result &= Test(out, "Token::ColonEq",   Testlet("Token::ColonEq",    pink::Token::ColonEq));
    result &= Test(out, "Token::Semicolon", Testlet("Token::Semicolon",  pink::Token::Semicolon));
    ...
    result &= Test(out, "Token::LBrace",    Testlet("Token::LBrace",     pink::Token::LBrace));
    result &= Test(out, "Token::RBrace",    Testlet("Token::RBrace",     pink::Token::RBrace));
    result &= Test(out, "Token::LBracket",  Testlet("Token::LBracket",   pink::Token::LBracket));
    result &= Test(out, "Token::RBracket",  Testlet("Token::RBracket",   pink::Token::RBracket));
    ...
    result &= Test(out, "Token::While",     Testlet("Token::While",      pink::Token::While));
