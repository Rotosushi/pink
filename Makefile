...
AUX1_OBJS=build/TypeInterner.o build/Environment.o

BUILD_OBJS:=$(AUX0_OBJS) $(AUX1_OBJS) $(AST0_OBJS) $(AST1_OBJS) $(TYP0_OBJS)
...
aux: location error string_interner symbol_table type_interner environment
...
TEST_AUX2_OBJS=test/build/TestEnvironment.o
...
TEST_OBJS= $(TEST_AUX_OBJS) $(TEST_AST_OBJS) $(TEST_TYPE_OBJS)
...
tests: test_main test_header test_aux test_ast test_type
...
test_aux: test_error test_string_interner test_symbol_table test_type_interner test_environment
...
commit:
	git add include/* src/* test/include/* test/src/*
	git commit
